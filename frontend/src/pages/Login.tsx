    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (err.code === 'auth/email-already-in-use') {
                setError('This email is already registered. Please sign in instead, or use "Forgot Password" if you need to reset it.');
                ...
                setError('This account exists but was created with Google Sign-In. Please use the "Continue with Google" button above.');
            } else {
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center gap-3 mb-4">
                        ...
                        <h1 className="text-3xl font-bold text-slate-900">PoliCRM</h1>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-xl max-w-md w-full">
                        ...
                        <form onSubmit={handlePasswordReset}>
                            <input
                                ...
                                required
                                className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent mb-4"
                            />
