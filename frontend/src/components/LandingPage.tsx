    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 text-foreground overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
          ...
          >
            ...
            >
              Streamline member management, automate AEC verification, and power
              your campaign with the{" "}
              <span className="text-indigo-600 font-bold">
                only CRM built for Australian parties
              </span>
              .
            </motion.p>
      ...
      <section id="features" className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            >
              Purpose-built tools designed specifically for the unique
              challenges of Australian political organizing.
            </motion.p>
          </div>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div
            className="absolute inset-0 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 animate-gradient"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-indigo-100 mb-12 max-w-2xl mx-auto leading-relaxed">
              Join the beta today and be among the first to experience the
              future of political organizing in Australia.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-2">
              ...
              <p className="max-w-xs leading-relaxed">
                The modern standard for Australian political party management.
                Secure, compliant, and powerful.
              </p>
            </div>
            <div>
    ...
    <section className="py-24 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="bg-slate-900 rounded-3xl overflow-hidden shadow-2xl relative">
          ...
          <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-96 h-96 bg-purple-500/30 rounded-full blur-3xl" />

          <div className="grid md:grid-cols-2 gap-12 p-8 md:p-12 relative z-10 items-center">
            <div>
              ...
              <p className="text-slate-300 text-lg mb-8 leading-relaxed">
                Facing a critical VEC deadline and $640k in funding at risk,
                Fusion Party needed a miracle. PoliCRM delivered.
              </p>

              <div className="space-y-4">
                {[
                  "Met VEC registration deadline with 911 verifications",
                  "Secured $640k in potential funding eligibility",
                  "Replacing NationBuilder for massive cost savings",
                  "Built custom compliance workflows for competitive advantage",
                ].map((item, i) => (
              ...
              <div className="mt-10">
                <p className="text-indigo-200 font-medium italic">
                  "Your party could do the same."
                </p>
              </div>
            </div>

            <div className="relative">
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 transform md:rotate-2 hover:rotate-0 transition-transform duration-500">
                {/* Abstract representation of the dashboard or success metrics */}
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-400">Processed Members</span>
                      <span className="text-white font-medium">911 / 911</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4">
                    ...
                    <div className="bg-slate-700/30 rounded-xl p-4">
                      ...
                      <div className="text-xl font-bold text-white">$640k</div>
                    </div>
                  </div>
                </div>
              </div>
